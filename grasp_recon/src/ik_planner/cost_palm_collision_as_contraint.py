        ...
        if(c_data[i]):# If not empty
            for j in range(len(c_data[i])):
                ...
                if (p_d > 0.0):  # If objects are in collision:
                    ...
                    l_col += w_c * np.abs(-p_d - dyn_model.d_safe)**2
                else:
                    l_col += 0.0
        ...
        if(c_data[i]):# If not empty
            ...
            for j in range(len(c_data[i])):
                ...
                if (p_d > 0.0):  # If objects are in collision:
                    ...
                    l_col += w_cf  * np.abs(-p_d - dyn_model.d_safe)**2
