...
_LBR4_EE ='right_gripper'
_LBR4_BASE = 'base'
#_J_NAMES=['torso_t0','right_torso_arm_mount','right_s0','right_s1','right_e0','right_e1','right_w0','right_w1','right_w2','right_endpoint']
_LBR4_LINK_NAMES=['right_upper_shoulder','right_lower_shoulder','right_upper_elbow','right_lower_elbow','right_upper_forearm','right_lower_forearm',
             'right_wrist','right_gripper_base']
...
_ALLEGRO_FTIPS = ['r_gripper_l_finger_tip', 'r_gripper_r_finger_tip']
_ALLEGRO_LINK_NAMES = ['r_gripper_l_finger','r_gripper_l_finger_tip','r_gripper_r_finger','r_gripper_r_finger_tip']
...
_ALLEGRO_COLLISION_LINK_NAMES = ['r_gripper_l_finger','r_gripper_l_finger_tip','r_gripper_r_finger','r_gripper_r_finger_tip']
'''
rp=RosPack()
